...
const register = async (req, res) => {
    ...
    try {
        const userExits = await userServices.findByEmail(email);
        ...
        const newUser = await userServices.createSingleUser(req.body);
        ...
        await userServices.updateById(newUser.id, {
...
const changePassword = async (req, res) => {
    ...
    try {
        ...
        await userServices.updateByEmail(email, { password: newPassword});
...
const resetPassword = async (req, res) => {
    ...
    try {
        ...
        if (codeOtp === code) {
            ...
            await userServices.updateSingleUser(email, {password: newPassword});
        } else {
